  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="relative w-full">
        ...
        {/* 아래 추가 섹션 */}
        <div className="absolute bottom-0 left-0 h-[230px] w-full flex flex-col items-start justify-center z-10" style={{ paddingLeft: '50px' }}>
          <h2 className="mb-2 text-5xl text-white">한눈에 보이는 나만의 관계도</h2>
